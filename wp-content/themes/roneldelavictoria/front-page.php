                ...
                <div class="carousel-item active">
					...
					<div class="col-sm-5">
						<div class="banner_taital">
							...
							<a href="<?php echo home_url() ?>"><button class="buy_bt">Buy Now</button></a>
							<button class="more_bt">See More</button>
						</div>
					</div>
					<div class="col-sm-5">
						<div class="shoes_img"><img src="<?php echo get_template_directory_uri(); ?>/images/running-shoes.png"></div>
					</div>
				</div>
                </div>
    	    	...
    	    	<div class="row">
    	    		<div class="col-md-6">
    	    			<div class="about-img">
    	    				...
    	    				<div class="shoes-img"><img src="<?php echo get_template_directory_uri(); ?>/images/shoes-img1.png"></div>
    	    				<p class="sport_text">Men Sports</p>
    	    				<div class="dolar_text">$<strong style="color: #f12a47;">90</strong> </div>
    	    				<div class="star_icon">
    	    					<ul>
    	    						<li><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/star-icon.png"></a></li>
    	    						<li><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/star-icon.png"></a></li>
    	    						<li><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/star-icon.png"></a></li>
    	    						<li><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/star-icon.png"></a></li>
    	    						<li><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/star-icon.png"></a></li>
    	    		...
    	    		<div class="col-md-6">
    	    			<div class="about-img2">
    	    				<div class="shoes-img2"><img src="<?php echo get_template_directory_uri(); ?>/images/shoes-img2.png"></div>
    	    				<p class="sport_text">Men Sports</p>
    	    				<div class="dolar_text">$<strong style="color: #f12a47;">90</strong> </div>
    	    				<div class="star_icon">
    	    					<ul>
    ...
    <div class="collectipn_section_3 layuot_padding">
    	<div class="container">
    		<div class="racing_shoes">
    			<div class="row">
    				<div class="col-md-8">
    					<div class="shoes-img3"><img src="<?php echo get_template_directory_uri(); ?>/images/shoes-img3.png"></div>
    				</div>
    				<div class="col-md-4">
    		...
    		<div class="row">
    			<div class="col-sm-4">
    				<div class="best_shoes">
    					...
    					<div class="shoes_icon"><img src="<?php echo get_template_directory_uri(); ?>/images/shoes-img4.png"></div>
    					<div class="star_text">
    						<div class="left_part">
    							<ul>
    	    						<li><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/star-icon.png"></a></li>
    			...
    			<div class="col-sm-4">
    				<div class="best_shoes">
    					<p class="best_text">Best Shoes </p>
    					<div class="shoes_icon"><img src="<?php echo get_template_directory_uri(); ?>/images/shoes-img5.png"></div>
    					<div class="star_text">
    						<div class="left_part">
    							<ul>
    	    						<li><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/star-icon.png"></a></li>
    			...
    			<div class="col-sm-4">
    				<div class="best_shoes">
    					<p class="best_text">Best Shoes </p>
    					<div class="shoes_icon"><img src="<?php echo get_template_directory_uri(); ?>/images/shoes-img6.png"></div>
    					<div class="star_text">
    						<div class="left_part">
    							<ul>
    	    						<li><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/star-icon.png"></a></li>
    		...
    		<div class="row">
    			<div class="col-sm-4">
    				<div class="best_shoes">
    					...
    					<div class="shoes_icon"><img src="<?php echo get_template_directory_uri(); ?>/images/shoes-img7.png"></div>
    					<div class="star_text">
    						<div class="left_part">
    							<ul>
    	    						<li><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/star-icon.png"></a></li>
    			...
    			<div class="col-sm-4">
    				<div class="best_shoes">
    					<p class="best_text">Sports Shoes</p>
    					<div class="shoes_icon"><img src="<?php echo get_template_directory_uri(); ?>/images/shoes-img8.png"></div>
    					<div class="star_text">
    						<div class="left_part">
    							<ul>
    	    						<li><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/star-icon.png"></a></li>
    			...
    			<div class="col-sm-4">
    				<div class="best_shoes">
    					<p class="best_text">Sports Shoes</p>
    					<div class="shoes_icon"><img src="<?php echo get_template_directory_uri(); ?>/images/shoes-img9.png"></div>
    					<div class="star_text">
    						<div class="left_part">
    							<ul>
    	    						<li><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/star-icon.png"></a></li>
